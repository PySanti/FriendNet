...
import {NotificationsWSSetPriorityMsgReception} from "./NotificationsWSSetPriorityMsgReception"
/**
...
export function NotificationsWSInitialize(userId, setNotificationsIdsCached){
    ...
    NOTIFICATIONS_WEBSOCKET.current.onopen = ()=>{
        ...
        NotificationsWSSetPriorityMsgReception(setNotificationsIdsCached)
    }
}